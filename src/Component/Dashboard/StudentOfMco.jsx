...
export default function StudentOfMco() {
  ...
  const enrollmentCount = useMemo(() => {
    ...
    return allStudentofMco.filter(student => student.status.status === 'enrollment').length;
  }, [allStudentofMco]);

  const dropoutCount = useMemo(() => {
    if (!allStudentofMco) return 0;
    return allStudentofMco.filter(student => student.status.status === 'dropout').length;
  }, [allStudentofMco]);
  ...
  return (
    <div className="grid justify-between gap-2 items-center grid-cols-3">
      <div className="bg-white rounded-md drop-shadow-md p-3 flex gap-5 items-center" >
        ...
        <div >
            <h1 className="text-xl font-semibold text-customPurple">Total Students</h1>
      ...
      <div className="bg-white rounded drop-shadow-md p-3 flex gap-5 items-center" >
        ...
        <div >
            <h1 className="text-xl font-semibold text-customPurple">Enrolled Students</h1>
      ...
      <div className="bg-white rounded drop-shadow-md p-3 flex gap-5 items-center" >
        ...
        <div >
            <h1 className="text-xl font-semibold text-customPurple">Dropout Students</h1>
